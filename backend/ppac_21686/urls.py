...
admin.site.site_header = "PPAC"
admin.site.site_title = "PPAC Admin Portal"
admin.site.index_title = "PPAC Admin"

# swagger
api_info = openapi.Info(
    title="PPAC API",
    default_version="v1",
    description="API documentation for PPAC App",
)
